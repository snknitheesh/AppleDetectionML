...
from data.apple_dataset import AppleDataset_frcnn
from data.apple_dataset import AppleDataset_mrcnn
...
def main(args):
    ...
    if args.model == 'maskrcnn':
        dataset = AppleDataset_mrcnn(os.path.join(args.data_path, 'train'), get_transform(train=True))
        dataset_test = AppleDataset_mrcnn(os.path.join(args.data_path, 'test'), get_transform(train=False))
    else:
        dataset = AppleDataset_frcnn(os.path.join(args.data_path, 'train'), get_transform(train=True))
        dataset_test = AppleDataset_frcnn(os.path.join(args.data_path, 'test'), get_transform(train=False))
